...
function createClassScope({ cacheReferenceName } = {}) {
    const self = class ModuleContext {
        ...
        static targetCounter = { // number of created target objects.
            cached: 0, 
            ...
            let handler = {
                ...
                apply: (target, thisArg, argumentsList) => {
                    ...
                    if(cacheContext.cacheName && self.targetCachedList[cacheContext.cacheName]) {
                        ...
                        if(process.env.SZN_DEBUG) { // for debug purposes, cache target objects with automatically named references.
    ...
    Object.defineProperty(self, 'ModuleContextCachedList', { get: function() {
